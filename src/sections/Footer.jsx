    ...
    <footer
      ...
      <div className="flex gap-4">
        <a
          ...
          className="p-2 rounded-full bg-[rgba(30,20,50,0.5)] hover:bg-[rgba(127,90,240,0.3)] transition">
      ...
      {/* Copyright */}
      <p className="text-white-400 text-center md:text-right text-sm">© All Rights Reserved by WCE ACSES</p>
    </footer>
  );
};
